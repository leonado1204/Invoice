		...
		<div class="row">
			<div class="col-md-6" id="client_info">
							...
							<select name="repeatcust" id="custsel" class="form-control">
								...
								@if( $rc->count() > 0 )
									...
									<option value="{!! $ec->id !!}" 
										...
										data-mobile_phone="{!! $ec->client_mobile !!}" 
										data-country="{!! $ec->country !!}" 
										data-city="{!! $ec->city !!}" 
										data-state="{!! $ec->state_province !!}" 
				...
				<div id="client_detail">
					{!! Form::open(['route' => 'customers.store', 'class' => 'form-horizontal', 'id' => 'form']) !!}
						<div class="form-group container " style="margin-bottom:20px" >
							...
							<div class="form-control-wrap col-sm-12">
								<input type="text" name="client" class="form-control" id="fullname" placeholder="Enter the Name" required>
							</div>
						</div>	
						...
						<div class="form-group container " style="margin-bottom:20px">
							...
							<div class="form-control-wrap col-sm-8">
								<input type="email" name="client" class="form-control" id="mail" placeholder="Email" required>
							</div>
						</div>	
						...
						<div class="form-group container d-flex" style="margin-bottom:20px" >
							<div class="col-sm-6">
								...
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="sAddress" placeholder="Street Address" required>
								</div>
							</div>
							...
							<div class="col-sm-6">
								...
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="addressLine2" placeholder="Address line 2" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group container d-flex" style="margin-bottom:20px">
							<div class="col-sm-4">
								...
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="city" placeholder="City" required>
								</div>
							</div>
							<div class="col-sm-4">
								<label class="form-label ">State:</label>
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="state" placeholder="State" required>
								</div>
							</div>
							<div class="col-sm-4">
								<label class="form-label ">Postal/Zip Code :</label>
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="pos" placeholder="Postal/Zip Code" required>
								</div>
							</div>
						</div>	
						<div class="form-group container d-flex" style="margin-bottom:20px">
							<div class="col-sm-6">
								...
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="tel" placeholder="Telephone" required>
								</div>
							</div>
							...
							<div class="col-sm-6">
								...
								<div class="form-control-wrap  ">
									<input type="text" name="client" class="form-control" id="mobilephone" placeholder="Mobile Phone" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group container" style="margin-bottom:20px">
							...
							<div class="form-control-wrap col-sm-12">
								<input type="text" name="client" class="form-control" id="country" placeholder="Country" required>
							</div>
						</div>	
					...
					<div class="row">
						<div class="form-group {!! ( count($errors->get('client'))  > 0 )? 'has-error' : '' !!} col-md-12" id="full_name">
					...
					<div class="row">
						<div class="form-group {!! ( count($errors->get('client_email')) ) >0 ? 'has-error' : '' !!}  col-md-6" id="client_email">
			...
			<div class="col-md-5" id="vehicle_info"><br/>
				...
				<table class="table table-bordered" id="vInfoTable">
					...
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'make', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'make']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'model', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'model']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'colour', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'colour']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('engNum', 'make', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'engNum']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'weight', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'weight']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('bodyStyle', 'make', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'bodyStyle']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'exported', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'exported']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'geatBox', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'gearBox']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'modelSetupDate', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'modelSetupDate']) !!}
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="row" style="padding-left: 10%;">
								{!! Form::input('text', 'firRegis', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '', 'id' => 'firRegis']) !!}
							</div>
						</td>
					</tr>
				</table>
