            ...
            <div id="client_detail">
                ...
                <div class="form-group container " style="margin-bottom:20px">
                    ...
                    <div class="form-control-wrap col-sm-12">
                        <input type="text" name="client" class="form-control" id="fullname" placeholder="Enter the Name"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group container d-flex" style="margin-bottom:20px">
                    <div class="col-sm-6">
                        ...
                        <div class="form-control-wrap  ">
                            <input type="text" name="client" class="form-control" id="sAddress"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-control-wrap  ">
                            <input type="text" name="client" class="form-control" id="addressLine2"
                ...
                <div class="form-group container d-flex" style="margin-bottom:20px">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-control-wrap  ">
                            <input type="text" name="client" class="form-control" id="state" placeholder="State"
                                required>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="form-control-wrap  ">
                            <input type="text" name="client" class="form-control" id="pos" placeholder="Postal/Zip Code"
                                required>
                        </div>
                    </div>
                </div>
                <div class="form-group container d-flex" style="margin-bottom:20px">
                    <div class="col-sm-6">
                        ...
                        <div class="form-control-wrap  ">
                            <input type="text" name="client" class="form-control" id="tel" placeholder="Telephone"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-control-wrap  ">
                            <input type="text" name="client" class="form-control" id="mobilephone"
                ...
                <div class="form-group container" style="margin-bottom:20px">
                    ...
                    <div class="form-control-wrap col-sm-12">
                        <input type="text" name="client" class="form-control" id="country" placeholder="Country"
                            required>
                    </div>
                </div>
...
<div class="col-md-5" id="vehicle_info"><br />
    ...
    <table class="table table-bordered" id="vInfoTable">
        ...
        <tr>
            ...
            <td>
                <div class="row" style="padding-left: 10%;">
                    {!! Form::input('engNum', 'make', @$value, ['class' => 'form-control col-md-8', 'placeholder' => '',
                    'id' => 'engNum']) !!}
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div class="row" style="padding-left: 10%;">
                    {!! Form::input('bodyStyle', 'make', @$value, ['class' => 'form-control col-md-8', 'placeholder' =>
                    '', 'id' => 'bodyStyle']) !!}
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div class="row" style="padding-left: 10%;">
                    {!! Form::input('text', 'geatBox', @$value, ['class' => 'form-control col-md-8', 'placeholder' =>
                    '', 'id' => 'gearBox']) !!}
                </div>
            </td>
        </tr>
